...
**[SQL_telco:]()** Data cleaning and preperation (using SQL)

> <span style="color:#FF6865">**Tools Used**: SQL </span> 


>
<iframe src="" width="105%" height="500" allowfullscreen scrolling="yes" style="border: 1px solid black; transform: scale(0.85); transform-origin: top left;"></iframe>
